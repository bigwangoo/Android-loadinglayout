package ui.tianxiabuyi.com.loadinglayout;
...
public class LoadingLayout extends FrameLayout {
    ...
    private int mLoadingResId = NO_ID, mEmptyResId = NO_ID, mErrorResId = NO_ID;
    ...
    public LoadingLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mLoadingResId = a.getResourceId(R.styleable.LoadingLayout_llLoadingResId, R.layout.tx_loading_layout_loading);
        mEmptyResId = a.getResourceId(R.styleable.LoadingLayout_llEmptyResId, R.layout.tx_loading_layout_empty);
        mErrorResId = a.getResourceId(R.styleable.LoadingLayout_llErrorResId, R.layout.tx_loading_layout_error);
