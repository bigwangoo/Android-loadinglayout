package com.tianxiabuyi.ui.loadinglayout;
...
public class LoadingLayout extends FrameLayout {
    ...
    private void initView(Context context, AttributeSet attrs) {
        TypedArray array = context.obtainStyledAttributes(attrs, R.styleable.LoadingLayout, 0, 0);
        //数据加载
        ...
        if (loadingLayoutId == R.layout.def_layout_network) {
            netImg = (ImageView) netView.findViewById(R.id.iv_network);
            netTv = (TextView) netView.findViewById(R.id.tv_network);
        }
        array.recycle();
